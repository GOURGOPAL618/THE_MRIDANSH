...
_GRID_TILER_PATH = os.path.abspath(
    os.path.join(
        ...
        "..", "..", "..", "2_data_pipeline", "preprocessing", "grid_tiler.py"
    )
)
...
async def get_gis_layer(
    ...
    try:
        if layer_type == "spatial_grid_mesh":
            ...
            tiles = tiler_engine.create_spatial_subgrids(bbox, rows = grid_rows, cols = grid_cols)
        ...
        raise HTTPException(
            ...
            detail = f"GIS Layer Generation Pipeline Error: {str(e)}",
        )
