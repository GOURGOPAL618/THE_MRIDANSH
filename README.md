...
| DAY | NOTEBOOK | MAIN WORK | VALIDATION | STATUS | RESULT |
|:---:|---|---|---|:---:|---|
| **43–45** | `05_physics_validation` | Richards/Darcy, physical constraints, physics loss, PINN experiment | Conservation/physical consistency + boundary-condition tests | ✅ COMPLETED | |
