...
|:---:|---|---|---|:---:|---|
| **35–36** | `01_data_ingestion` | STAC, Sentinel-1/2, DEM, weather, metadata | Data availability, CRS, timestamps, missing data | ✅ COMPLETE | Notebook 02 Completed Successfully 🟢 |
| **37–38** | `02_preprocessing` | Cloud masking, SAR/optical QC, normalization, alignment | Data leakage + spatial alignment checks | ✅ COMPLETE | Notebook 02 Completed Successfully 🟢 |
| **39–40** | `03_spatial_modeling` | Terrain features, graph construction, GCN experiment | Spatial ablation + unseen-area test | ✅ COMPLETE | Notebook 03 Completed Successfully 🟢 |
| **41–42** | `04_temporal_modeling` | Time-series construction, ConvLSTM experiment | Temporal holdout + sequence ablation | ✅ COMPLETE | Notebook 04 Completed Successfully 🟢 |
...
> **Shipped —** NOTEBOOK 04 COMPLETE ✅
> **Next up —** Notebook 05: WEEK 3 — Physics Constraints & State Estimation
