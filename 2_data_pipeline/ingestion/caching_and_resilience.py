...
class ResilientSatelliteIngestor:
    ...
    def __init__(
        self, cache_dir: str = ".cache/satellite_data", max_retries: int = 3 
    ):
    ...
    def _generate_cache_key(
        self, endpoint_name: str, params: Dict[str, Any]
    ) -> str:
    ...
    def execute_with_resilience(
        ...
        fallback_data_generator: Optional[
    ...
    def simulated_stac_api(params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if fetch_counter["calls"] == 1:
            raise ConnectionError(
                "HTTP 429: Too Many Requests - Simulated Rate Limit"
            )
