...
class CivilLoadTranslator(BaseDomainTranslator):
    ...
    def translate(self, soil_moisture: np.ndarray, dry_density_g_cm3: float = 1.6) -> Dict[str, Any]:
        logging.info("🏗️ Translating Soil State to Civil Bearing Capacity & Shear Strength...")
        ...
        bearing_capacity_kpa = effective_cohesion * 5.7 + (dry_density_g_cm3 * 9.81 * 1.5)
...
if __name__ == "__main__":
    ...
    assert "bearing_capacity_matrix_kPa" in res and res["bearing_capacity_matrix_kPa"].shape == (120, 120)
